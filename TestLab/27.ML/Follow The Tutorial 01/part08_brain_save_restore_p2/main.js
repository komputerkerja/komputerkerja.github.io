...
const trafics = [
    ...
    new Car(road.getLaneCount(2),canvasHeight*0.2, 30, 50, "DUMMY",2),
    ...
    new Car(road.getLaneCount(1),canvasHeight*-4.9, 30, 50, "DUMMY",2),
    ...
    new Car(road.getLaneCount(1),canvasHeight*-5.9, 30, 50, "DUMMY",2),
    new Car(road.getLaneCount(2),canvasHeight*-6.1, 30, 50, "DUMMY",2),
    new Car(road.getLaneCount(1),canvasHeight*-6.1, 30, 50, "DUMMY",2),
    new Car(road.getLaneCount(0),canvasHeight*-6.4, 30, 50, "DUMMY",2),
    new Car(road.getLaneCount(1),canvasHeight*-6.4, 30, 50, "DUMMY",2),
    new Car(road.getLaneCount(2),canvasHeight*-6.65, 30, 50, "DUMMY",2),
    new Car(road.getLaneCount(1),canvasHeight*-6.65, 30, 50, "DUMMY",2),
    new Car(road.getLaneCount(0),canvasHeight*-6.9, 30, 50, "DUMMY",2),
    new Car(road.getLaneCount(0),canvasHeight*-6.9, 30, 50, "DUMMY",2),
    new Car(road.getLaneCount(2),canvasHeight*-7.2, 30, 50, "DUMMY",2),
    new Car(road.getLaneCount(0),canvasHeight*-7.45, 30, 50, "DUMMY",2),
    new Car(road.getLaneCount(1),canvasHeight*-7.6, 30, 50, "DUMMY",2),
    new Car(road.getLaneCount(1),canvasHeight*-7.4, 30, 50, "DUMMY",2),
]
